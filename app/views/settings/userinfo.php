<div style="min-height:480px;">
    <?php if ($user->hasError() or $user->already_registered): ?>
    ...
    <form class="row panel callout" action="<?php echo_htmlschars(url('')); ?>" method="post">
        <div class="small-12 columns">
            <div class="row">
                <h5>Information</h5> <small>Please fill up all fields</small>
            </div>
            <div class="row">
                ...
                <div class="medium-6 columns">
                    ...
                    <?php else: ?>
                        <label>First Name
                    <?php endif; ?>
                        <input type="text" placeholder="Juan" name="user_fname" maxlength='30' value="<?php echo_htmlschars(Param::get('user_fname',get_session('logged_in','user_fname'))) ?>">
                        </label>
                </div>
                ...
                <div class="medium-6 columns">
                    ...
                    <?php else: ?>
                        <label>Last Name
                    <?php endif; ?>
                        <input type="text" placeholder="Dela Cruz" name="user_lname" maxlength='30' value="<?php echo_htmlschars(Param::get('user_lname',get_session('logged_in','user_lname'))) ?>">
                        </label>
                </div>
                ...
                <div class="medium-6 columns">
                    ...
                    <?php else: ?>
                        <label>Email
                    <?php endif; ?>
                        <input type="email" placeholder="example@sample.com" name="user_email" maxlength='30' value="<?php echo_htmlschars(Param::get('user_email',get_session('logged_in','user_email'))) ?>">
                        </label>
                ...
                <div class="medium-6 columns">
                    ...
                    <?php else: ?>
                        <label>Username
                    <?php endif; ?>
                        <input type="text" placeholder="jdelacruz" name="user_username" maxlength='30' value="<?php echo_htmlschars(Param::get('user_username',get_session('logged_in','user_username'))) ?>">
                        </label>
                </div>
